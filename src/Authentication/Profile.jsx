...
// //           params: {
// //             client_id: 'nq4dOujbQQ4i2oXxh1BGWfRnIWm3Ehpqdf-GasM1yUg',
// //             per_page: 6,
...
// //           <button className="bg-blue-500 text-white px-4 py-2 rounded">My Posts</button>
// //         </div>
// //         <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
// //           {photos.map((photo) => (
// //             <div key={photo.id} className="relative bg-gray-200 h-64">
...
//       <button
//         onClick={() => navigate('/upload')}
//         className="fixed z-50 bottom-4 right-4 bg-black p-3 rounded-full text-white focus:outline-none lg:relative lg:ml-4 lg:mt-2"
//       >
//         <FaPlus className="text-xl" />
//       </button>
//       <button onClick={handleLogout} className="mt-8 bg-red-500 text-white px-4 py-2 rounded">Logout</button>
...
const ProfilePage = ({ updateUser }) => {
  ...
  return (
    <div className="min-h-screen bg-gray-100 flex flex-col items-center">
      ...
      <button
        onClick={() => navigate('/upload')}
        className="fixed z-50 bottom-4 right-4 bg-black p-3 rounded-full text-white focus:outline-none"
      >
        <FaPlus className="text-xl" />
      </button>
      <button onClick={handleLogout} className="mt-8 bg-red-500 text-white px-4 py-2 rounded">Logout</button>
